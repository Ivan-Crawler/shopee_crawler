# -*- coding: utf-8 -*-
"""
Created on Tue Mar  2 20:09:47 2021
...
#抓到該關鍵字共有多少商品
def get_all_number(keyword, page):
    getjson = request_shopee(keyword, page)
...
container_product.to_csv(keyword +'_商品資料.csv', encoding = ecode)
container_comment.to_csv(keyword +'_留言資料.csv', encoding = ecode)
